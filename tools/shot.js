...
const SCREENS={
  ...
  boss:     {what:"BOSS I, a second in", js:"lv(16);", wait:1200},
  ...
  struggle: {what:"the skip offer after repeated losses", js:"lv(16);settings.noSlowOffer=false;setTimeout(struggleOffer,600);", wait:1400},
  ...
  phase:    {what:"the between-phases note on a boss", js:"lv(16);setTimeout(function(){phaseNote('the ground rises');},300);", wait:1200},
};
