...
| `docs/SHIPPING.md` | **taking it to Android, iOS and Steam**: the store clocks that set the calendar, `adChild()` and the mixed audience, the seven IAP products and the three-that-show-two upgrade, the Steam grant, the asset sizes |
